...
<div className='quick-information-container col-sm-4'>
...

 {
   mostSold.map((item,index)=>{
     return(
       <li style={{fontSize:'0.8',color:"red",fontWeight:"bold"}} className='most-sold-list'> {item.name.toLowerCase()}</li>
     )
   })
 }
...
<option value="lc"  className='form-select-option'>SORT BY LOWEST  COST</option>
    ...
    <div className='sales-table-container'>
     ...
     <div className='sales-table-header-container'>
      ...
      <div className='sales-header'> Quantity Before</div> 
      <div className='sales-header'> Quantity</div>
      <div className='sales-header'> Quantity After</div>
...
let quantityBefore= salesData.bQuantity
let quantityAfter= salesData.aQuantity

  if(salesData.packages==='bulks'){
    quantity=salesData.quantity/item.upb
    quantityBefore=salesData.bQuantity/item.upb
    quantityAfter=salesData.aQuantity/item.upb
  }
 ...
 return(
  ...
  <div  className='sales-element'>{quantityBefore?quantityBefore.toFixed(2):"N/A"}</div>
  <div  className='sales-element'>{quantity.toFixed(2)}</div>
  <div  className='sales-element'>{quantityAfter?quantityAfter.toFixed(2):"N/A"}</div>
